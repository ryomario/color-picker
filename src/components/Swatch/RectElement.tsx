...
import type { SwatchElementProps, SwatchRectRenderProps } from './SwatchElement';

interface RectElementProps extends SwatchRectRenderProps {
  rectProps?: SwatchElementProps['rectProps'];
}
...
export default function RectElement({ style, title, checked, onClick, rectProps }: RectElementProps) {
