...
export interface EyeDropperProps extends Omit<React.HTMLAttributes<HTMLButtonElement>, 'onClick'> {
  onPickColor?: (color: string) => void;
}

export function EyeDropper({ onPickColor, className = '', ...rest }: EyeDropperProps) {
  const click = () => {
